      ...
      bottomNavigationBar: Container(
        ...
        child: NavigationBarTheme(
          data: NavigationBarThemeData(
            ...
            backgroundColor: Colors.white,
            surfaceTintColor:
                Colors.transparent, // Quita el tinte morado/azul de Material 3
            indicatorColor:
                Colors.transparent, // Quita la pastilla de fondo al seleccionar
          ...
          child: NavigationBar(
            elevation:
                0, // Quitamos la elevación nativa porque usamos el borde del Container
